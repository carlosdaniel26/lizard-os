...
#define CPUID_VENDOR_PARALLELS_ALT                                                                           \
    " lrpepyh vr " /* Sometimes Parallels incorrectly encodes "prl hyperv" as "lrpepyh vr" due to            \
                      an endianness mismatch.*/
